package ma.archi.smart.archzy.util;

import ma.archi.smart.archzy.audit.AuditEntity;
import ma.archi.smart.archzy.audit.Log;
import ma.archi.smart.archzy.bean.BusinessObject;
import ma.archi.smart.archzy.bean.EnumBean;
